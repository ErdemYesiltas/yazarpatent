angular.module('app').directive('galbAlignVerticalCenter', function ($window) {
...
angular.module('app').directive('galbAlignVerticalCenterInContainer', function ($window) {
    function link(scope, element, attrs) {
        var ofsetTop = Number(attrs.ofsetTop) || 0;
        var align = function () {
...
angular.module('app').directive('galbImage', function ($window) {
    function link(scope, element, attrs) {
