angular.module('app').directive('alignVerticalCenterInContainer', function ($window) {
...
angular.module('app').directive('alignHorizontalCenter', function ($window) {
    function link(scope, element, attrs) {
...
angular.module('app').directive('alignOnResize', function ($window) {
    function link(scope, element, attrs) {
        $(window).bind('resize', function () {
            //var ww = $(window).width();
            var ww = $(window).width();
...
angular.module('app').directive('heightPercent', function ($window) {
    function link(scope, element, attrs) {
        function setSize() {
            var wh = $(window).height();
