angular.module('app').directive('slideTween', function ($window)
{
...
angular.module('app').directive('absoluteSliderItem', function ($window)
{
    function link(scope, element, attrs)
    {
...
angular.module('app').directive('absoluteFadeInItem', function ($window)
{
    function link(scope, element, attrs)
    {
